...
export const templateConfig = {
  name: "Loyalty Chair Spin",
  slug: "loyalty-chair-spin",
  vertical: "barbershop",
  version: "v1.0",
  description: "Treat your regulars, upsell beard care, and spotlight premium products.",
  expiry_days: 21,
  min_stars: 4,
  prizes: [
    { label: "VIP grooming bundle", probability: 0.04 },
    { label: "Free travel-size beard oil", probability: 0.25 },
    { label: "15% off any grooming service", probability: 0.4 },
    { label: "Free shampoo sample pack", probability: 0.31 }
  ],
  disclaimer: `Every spin wins. 🪒

Prizes must be redeemed within 21 days of your review. One prize per visit. No cash value. Substitutions may apply based on stock. Redemption requires showing your winning screen at the front desk. QR reuses or screenshots are not valid.`
};

export default function LoyaltyChairSpinPage() {
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto p-10 bg-white shadow-md rounded-xl mt-8">
        ...
        <img
          src="https://images.unsplash.com/photo-1585747860715-2ba37e788b70?q=80&w=2948&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Grooming products display"
